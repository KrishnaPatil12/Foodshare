...
<style>
    ...
    .waiting { background: #fff3cd; color: #b88600; }
    .assigned { background: #d1ecf1; color: #0c5460; }
    .picked { background: #fcefee; color: #a4344d; }
...
while(rs.next()){
    ...
    String cssClass = "";
    if(status.equals("Waiting for volunteer")) cssClass = "waiting";
    else if(status.equals("Volunteer assigned")) cssClass = "assigned";
    else if(status.equals("Picked up")) cssClass = "picked";
%>
