...
<div class="login-card">
  ...
  <a class="register-link" href="Vregister.jsp">New here? Register</a>
...
if(email != null && password != null){
    try {
        ...
        PreparedStatement ps = con.prepareStatement("SELECT volunteer_id, name FROM volunteer WHERE email=? AND password=?");
        ...
        if(rs.next()){
            ...
            Getset.setId(id); // store session ID
